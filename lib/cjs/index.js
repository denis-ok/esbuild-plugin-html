...
const htmlPlugin = (configuration = { files: [], }) => {
    ...
    async function renderTemplate({ htmlTemplate }) {
    ...
    function injectFilesToHtmlTemplate(htmlTemplate, assets, outDir, publicPath, htmlFileConfiguration) {
        ...
        setup(build) {
            ...
            build.onEnd(async (result) => {
                ...
                for (const htmlFileConfiguration of configuration.files) {
                    ...
                    await fs_1.default.promises.writeFile(out, modifiedHtmlTemplate);
